...
/* DFN pages */
static button_data_t btn_dfn_p1 = make_page_btn("(DFN 1:3)", "D N F page");
static button_data_t btn_dfn_p2 = make_page_btn("(DFN 2:3)", "N B page");
static button_data_t btn_dfn_p3 = make_page_btn("(DFN 3:3)", "N R page");
